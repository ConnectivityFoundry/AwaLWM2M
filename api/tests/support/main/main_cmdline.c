...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->bootstrapServerCoapPort_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->bootstrapServerCoapPort_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bootstrapServerCoapPort_help = gengetopt_args_info_help[6] ;
  args_info->logLevel_help = gengetopt_args_info_help[7] ;
  args_info->coapClientPath_help = gengetopt_args_info_help[8] ;
  args_info->clientDaemonPath_help = gengetopt_args_info_help[9] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->bootstrapServerCoapPort_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->bootstrapServerCoapPort_given)
    write_into_file(outfile, "bootstrapServerCoapPort", args_info->bootstrapServerCoapPort_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "bootstrapServerCoapPort",	1, NULL, 0 },
        { "logLevel",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* External LWM2M Bootstrap Server CoAP Port.  */
          else if (strcmp (long_options[option_index].name, "bootstrapServerCoapPort") == 0)
          {
