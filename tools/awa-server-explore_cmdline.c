/*
  ...
  gengetopt --input=awa-server-explore.cmdline --include-getopt --unamed-opts=PATHS --file awa-server-explore_cmdline 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -e, --export              Export definitions in XML format  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->export_help = gengetopt_args_info_help[5] ;
  args_info->ipcAddress_help = gengetopt_args_info_help[6] ;
  args_info->ipcPort_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->export_given)
    write_into_file(outfile, "export", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvdqea:p:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'q':	/* Decrease program verbosity.  */
          ...
          break;
        case 'e':	/* Export definitions in XML format.  */
        
        
          if (update_arg((void *)&(args_info->export_flag), 0, &(args_info->export_given),
              &(local_args_info.export_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "export", 'e',
              additional_error))
            goto failure;
