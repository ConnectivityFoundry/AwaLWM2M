...
TEST_F(Lwm2mDefinitionRegistryTestSuite, test_register_lookup_object)
{
    ...
    ASSERT_EQ(-1, Definition_RegisterResourceType(NULL, "test resource", 1000, 101, ResourceTypeEnum_TypeInteger, MultipleInstancesEnum_Single, MandatoryEnum_Optional, Operations_R, NULL, NULL));
    ASSERT_EQ(-1, Definition_RegisterResourceType(registry, "test resource", 2000, 101, ResourceTypeEnum_TypeInteger, MultipleInstancesEnum_Single, MandatoryEnum_Optional, Operations_R, NULL, NULL));
    ASSERT_EQ(0, Definition_RegisterResourceType(registry, "test resource", 1000, 101, ResourceTypeEnum_TypeInteger, MultipleInstancesEnum_Single, MandatoryEnum_Optional, Operations_R, NULL, NULL));
    ASSERT_EQ(-1, Definition_RegisterResourceType(registry, "test resource 1", 1000, 101, ResourceTypeEnum_TypeInteger, MultipleInstancesEnum_Single, MandatoryEnum_Optional, Operations_R, NULL, NULL));
