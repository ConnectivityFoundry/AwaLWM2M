...
TEST_F(TlvTestSuite, test_serialise_string)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 0, 0, AwaResourceType_String, 1, 0, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_bool)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 1, 0, AwaResourceType_Boolean, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_int8)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 2, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_negative_int8)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 3, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_int16)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 4, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_negative_int16)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 5, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_int32)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 6, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_negative_int32)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 7, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_int64)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 8, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_negative_int64)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 9, 0, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_float32)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 10, 0, AwaResourceType_Float, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_serialise_float64)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 11, 0, AwaResourceType_Float, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_ident_8bit)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 12, 1, AwaResourceType_Integer, 1, 0, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_ident_16bit)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 13, 1024, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
...
TEST_F(TlvTestSuite, test_multiple_instance_resource)
{
    ...
    ASSERT_EQ(0, Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 14, 0, AwaResourceType_Integer, 2, 1, Operations_RW, &defaultResourceOperationHandlers));
...
TEST_F(TlvTestSuite, test_serialise_object_with_two_resources)
{
    ...
    Lwm2mCore_RegisterResourceType(context, (char*)"Res1", 16, 0, AwaResourceType_String, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
    Lwm2mCore_RegisterResourceType(context, (char*)"Res2", 16, 1, AwaResourceType_Integer, 1, 1, Operations_RW, &defaultResourceOperationHandlers);
