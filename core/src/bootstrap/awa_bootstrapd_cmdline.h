...
#ifndef AWA_BOOTSTRAPD_CMDLINE_H
#define AWA_BOOTSTRAPD_CMDLINE_H
...
#define CMDLINE_PARSER_PACKAGE "awa_bootstrapd"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "awa_bootstrapd"
#endif
...
struct gengetopt_args_info
{
  ...
  char * ip_arg;	/**< @brief Accept client bootstrap requests on IP address ADDR (default='0.0.0.0').  */
  char * ip_orig;	/**< @brief Accept client bootstrap requests on IP address ADDR original value given at command line.  */
  const char *ip_help; /**< @brief Accept client bootstrap requests on IP address ADDR help description.  */
  char * interface_arg;	/**< @brief Accept client bootstrap requests on network interface IF.  */
  char * interface_orig;	/**< @brief Accept client bootstrap requests on network interface IF original value given at command line.  */
  const char *interface_help; /**< @brief Accept client bootstrap requests on network interface IF help description.  */
  ...
  int port_arg;	/**< @brief Use port number PORT for CoAP communications (default='15685').  */
  ...
  char ** config_arg;	/**< @brief Load server list configuration from FILE.  */
  char ** config_orig;	/**< @brief Load server list configuration from FILE original value given at command line.  */
  unsigned int config_min; /**< @brief Load server list configuration from FILE's minimum occurreces */
  unsigned int config_max; /**< @brief Load server list configuration from FILE's maximum occurreces */
  const char *config_help; /**< @brief Load server list configuration from FILE help description.  */
...
#endif /* __cplusplus */
#endif /* AWA_BOOTSTRAPD_CMDLINE_H */
