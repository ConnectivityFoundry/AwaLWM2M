/*
  ...
  gengetopt --input=awa_bootstrapd.ggo --include-getopt --unamed-opts=PATHS --file awa_bootstrapd_cmdline --no-version
...
const char *gengetopt_args_info_purpose = "Awa LWM2M Bootstrap Server";

const char *gengetopt_args_info_usage = "Usage: awa_bootstrapd [OPTIONS]... [PATHS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -a, --ip=ADDR           Accept client bootstrap requests on IP address ADDR\n                            (default=`0.0.0.0')",
  "  -e, --interface=IF      Accept client bootstrap requests on network interface\n                            IF",
  ...
  "  -c, --config=FILE       Load server list configuration from FILE",
  ...
  "\nExample:\n    awa_bootstrapd --port 15685 --config bootstrap.config\n\n",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->config_max = 4;
  args_info->secure_help = gengetopt_args_info_help[6] ;
  args_info->daemonize_help = gengetopt_args_info_help[7] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "ha:e:f:p:c:sdvl:V", long_options, &option_index);
