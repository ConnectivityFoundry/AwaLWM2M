/*
  ...
  gengetopt --no-version --input=awa_clientd.cmdline --include-getopt --unamed-opts=PATHS --file awa_clientd_cmdline 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bootstrap_help = gengetopt_args_info_help[8] ;
  args_info->factoryBootstrap_help = gengetopt_args_info_help[9] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->addressFamily_given)
    write_into_file(outfile, "addressFamily", args_info->addressFamily_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hp:a:i:e:dvl:b:f:V", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Address family for network interface. AF=4 for IPv4, AF=6 for IPv6.  */
          ...
          if (update_arg( (void *)&(args_info->addressFamily_arg), 
              ...
              &(local_args_info.addressFamily_given), optarg, 0, "4", ARG_INT,
              check_ambiguity, override, 0, 0,
              "addressFamily", 'a',
              additional_error))
            goto failure;
