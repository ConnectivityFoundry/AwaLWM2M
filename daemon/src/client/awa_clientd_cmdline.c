/*
  ...
  gengetopt --input=awa_clientd.ggo --include-getopt --unamed-opts=PATHS --file awa_clientd_cmdline --no-version
...
const char *gengetopt_args_info_purpose = "Awa LWM2M Client";

const char *gengetopt_args_info_usage = "Usage: awa_clientd [OPTIONS]... [PATHS]...";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->endPointName_arg = gengetopt_strdup ("Awa Client");
  args_info->endPointName_orig = NULL;
  args_info->bootstrap_arg = NULL;
  ...
  args_info->pskIdentity_arg = NULL;
  args_info->pskIdentity_orig = NULL;
  args_info->pskKey_arg = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->port_help = gengetopt_args_info_help[1] ;
  args_info->addressFamily_help = gengetopt_args_info_help[2] ;
  args_info->ipcPort_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->endPointName_arg));
  free_string_field (&(args_info->endPointName_orig));
  ...
  free_string_field (&(args_info->pskIdentity_arg));
  free_string_field (&(args_info->pskIdentity_orig));
  free_string_field (&(args_info->pskKey_arg));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->endPointName_given)
    write_into_file(outfile, "endPointName", args_info->endPointName_orig, 0);
  ...
  if (args_info->pskIdentity_given)
    write_into_file(outfile, "pskIdentity", args_info->pskIdentity_orig, 0);
  if (args_info->pskKey_given)
